...
public class TradeEnrichmentRequest {
    ...
    public TradeEnrichmentRequest() {
    }

    public TradeEnrichmentRequest(final String tradeId, final String instrumentType, final String underlyingAsset,
            final BigDecimal notionalAmount, final String currency, final BigDecimal strikePrice,
            final LocalDate maturityDate, final String direction) {
